...
public class CañonConico extends Ataque {
    ...
    @Override
    public void dañar(Chimpokomon chipoAtacante, Chimpokomon chipoAtacado) {
        if (chipoAtacante.tieneVentajaSobre(chipoAtacado)) {
            chipoAtacado.restarVida(5);
