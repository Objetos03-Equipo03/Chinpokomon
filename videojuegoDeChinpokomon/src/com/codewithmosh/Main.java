...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Carnotron carnotron = new Carnotron(List.of(RayoVeloz, cañonConico), 2);

        // Segundo Chinpokomon
        GarraMecanica garraMecanica = new GarraMecanica();
        Gallotronix gallotronix = new Gallotronix(List.of(garraMecanica), 2);

        // Tercer chinpokomon
        Zapato zapato = new Zapato(List.of(new Zapatazo()),2);
        Zapato zapato5 = new Zapato(List.of(new Zapatazo(), new PomadaWassington()),3);
        ...
        // imprimir gallotronix
        System.out.println(gallotronix.getNaturaleza());
